...
from asosiy.views import MahsulotApiView, Qarzdorlik_sotuvchiApiView, Qarzdorlik_mijozApiView, KirmApiView, MahsulotOzgartirishApiView,Qarzdorlik_sotuvchiOzgartirishApiView, Qarzdorlik_mijozOzgartirishApiView, KirimOzgartirishApiView
...
urlpatterns = [
    ...
    path('kirim/', KirmApiView.as_view()),
